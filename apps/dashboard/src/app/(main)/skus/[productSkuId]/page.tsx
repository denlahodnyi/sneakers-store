  ...
  return (
    <PageContentContainer>
      ...
      <Attribute>
        ...
        <AttributeValue>{productSku.name || 'N/A'}</AttributeValue>
      </Attribute>
      <Attribute>
        <AttributeName>Slug</AttributeName>
        <AttributeValue>{productSku.slug || 'N/A'}</AttributeValue>
      </Attribute>
      <Attribute>
      ...
      <Attribute>
        ...
        <AttributeValue>{`$${productSku.basePrice / 100}`}</AttributeValue>
      </Attribute>
      <Attribute>
